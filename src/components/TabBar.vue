...
defineProps<{
  activeTab: 'site' | 'code' | 'terminal' | 'agent' | 'tools'
}>()

const emit = defineEmits<{
  'update:activeTab': [value: 'site' | 'code' | 'terminal' | 'agent' | 'tools']
}>()
...
<template>
  <div class="bg-white border-b border-stone-200 shrink-0 flex items-center px-2">
    <button
      v-for="tab in tabs"
      :key="tab.key"
